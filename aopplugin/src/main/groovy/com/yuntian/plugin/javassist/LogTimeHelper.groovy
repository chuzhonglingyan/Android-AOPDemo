...
class LogTimeHelper {
    ...
    final static String LogTimeAnnotation = "com.yuntian.aoplib.annotation.LogTime";

    //  时间log先注释掉           f (mAnnotation.annotationType().canonicalName.equals(LogTimeHelper.LogTimeAnnotation))
